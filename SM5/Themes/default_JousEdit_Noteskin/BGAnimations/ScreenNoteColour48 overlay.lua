...
local function Update(self)
	...
	if GetUserPref("Use10sinsteadof1s") == "1" then
		red = GetUserPrefN("NoteskinColour48Red")*10/256;
		green = GetUserPrefN("NoteskinColour48Green")*10/256;
		blue = GetUserPrefN("NoteskinColour48Blue")*10/256;
	else
		red = GetUserPrefN("NoteskinColour48Red")/256;
		green = GetUserPrefN("NoteskinColour48Green")/256;
		blue = GetUserPrefN("NoteskinColour48Blue")/256;
	end;
