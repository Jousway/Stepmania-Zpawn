...
local function Update(self)
	...
	if GetUserPref("Use10sinsteadof1s") == "1" then
		red = GetUserPrefN("NoteskinColour32Red")*10/256;
		green = GetUserPrefN("NoteskinColour32Green")*10/256;
		blue = GetUserPrefN("NoteskinColour32Blue")*10/256;
	else
		red = GetUserPrefN("NoteskinColour32Red")/256;
		green = GetUserPrefN("NoteskinColour32Green")/256;
		blue = GetUserPrefN("NoteskinColour32Blue")/256;
	end;
