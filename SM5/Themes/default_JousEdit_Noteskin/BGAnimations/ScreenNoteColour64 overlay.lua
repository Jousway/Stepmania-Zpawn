...
local function Update(self)
	...
	if GetUserPref("Use10sinsteadof1s") == "1" then
		red = GetUserPrefN("NoteskinColour64Red")*10/256;
		green = GetUserPrefN("NoteskinColour64Green")*10/256;
		blue = GetUserPrefN("NoteskinColour64Blue")*10/256;
	else
		red = GetUserPrefN("NoteskinColour64Red")/256;
		green = GetUserPrefN("NoteskinColour64Green")/256;
		blue = GetUserPrefN("NoteskinColour64Blue")/256;
	end;
