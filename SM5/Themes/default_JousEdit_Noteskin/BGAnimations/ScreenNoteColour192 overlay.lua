...
local function Update(self)
	...
	if GetUserPref("Use10sinsteadof1s") == "1" then
		red = GetUserPrefN("NoteskinColour192Red")*10/256;
		green = GetUserPrefN("NoteskinColour192Green")*10/256;
		blue = GetUserPrefN("NoteskinColour192Blue")*10/256;
	else
		red = GetUserPrefN("NoteskinColour192Red")/256;
		green = GetUserPrefN("NoteskinColour192Green")/256;
		blue = GetUserPrefN("NoteskinColour192Blue")/256;
	end;
