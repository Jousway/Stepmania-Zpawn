...
local function Update(self)
	...
	if GetUserPref("Use10sinsteadof1s") == "1" then
		red = GetUserPrefN("NoteskinColour8Red")*10/256;
		green = GetUserPrefN("NoteskinColour8Green")*10/256;
		blue = GetUserPrefN("NoteskinColour8Blue")*10/256;
	else
		red = GetUserPrefN("NoteskinColour8Red")/256;
		green = GetUserPrefN("NoteskinColour8Green")/256;
		blue = GetUserPrefN("NoteskinColour8Blue")/256;
	end;
