...
local function Update(self)
	...
	if GetUserPref("Use10sinsteadof1s") == "1" then
		red = GetUserPrefN("NoteskinColour16Red")*10/256;
		green = GetUserPrefN("NoteskinColour16Green")*10/256;
		blue = GetUserPrefN("NoteskinColour16Blue")*10/256;
	else
		red = GetUserPrefN("NoteskinColour16Red")/256;
		green = GetUserPrefN("NoteskinColour16Green")/256;
		blue = GetUserPrefN("NoteskinColour16Blue")/256;
	end;
