...
local function Update(self)
	...
	if GetUserPref("Use10sinsteadof1s") == "1" then
		red = GetUserPrefN("NoteskinColour24Red")*10/256;
		green = GetUserPrefN("NoteskinColour24Green")*10/256;
		blue = GetUserPrefN("NoteskinColour24Blue")*10/256;
	else
		red = GetUserPrefN("NoteskinColour24Red")/256;
		green = GetUserPrefN("NoteskinColour24Green")/256;
		blue = GetUserPrefN("NoteskinColour24Blue")/256;
	end;
