...
local function Update(self)
	...
	if GetUserPref("Use10sinsteadof1s") == "1" then
		red = GetUserPrefN("NoteskinColour12Red")*10/256;
		green = GetUserPrefN("NoteskinColour12Green")*10/256;
		blue = GetUserPrefN("NoteskinColour12Blue")*10/256;
	else
		red = GetUserPrefN("NoteskinColour12Red")/256;
		green = GetUserPrefN("NoteskinColour12Green")/256;
		blue = GetUserPrefN("NoteskinColour12Blue")/256;
	end;
