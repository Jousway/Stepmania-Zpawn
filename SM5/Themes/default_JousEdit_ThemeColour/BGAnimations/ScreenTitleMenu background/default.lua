...
t[#t+1] = Def.ActorFrame {
	...
	Def.Quad {
		...
		OnCommand=cmd(diffuse,color(string.format("%f, %f, %f, %f", red, green, blue, "1")));
	};
	Def.ActorFrame {
		...
		Def.ActorFrame {
			...
			LoadActor(THEME:GetPathB("ScreenWithMenuElements","background/_checkerboard")) .. {
				...
				OnCommand=cmd(texcoordvelocity,0,0.5;diffuse,color(string.format("%f, %f, %f, %f", red, green, blue, "1"));diffusealpha,0.5;fadetop,1;fadebottom,1);
			};
		};
	};
};
